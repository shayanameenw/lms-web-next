...
import type {Course, Attachment} from "~/lib/db"
...
export function AttachmentForm({initialData, courseId}: AttachmentFormProps): ReactNode {
    ...
    !isEditing
      ...
      <div className={cn("p-4 space-y-2 rounded-lg bg-muted")}>
        ...
        {initialData.attachments.length > 0
          ...
          :
          <p className={cn("text-sm text-foreground/75 italic")}>No Attachments</p>
        }
      </div>
      :
