...
export default function Page(): ReactNode {
  ...
  return (
    <section className={cn("py-4 px-8 h-[calc(100vh_-_4rem)]")}>
      <div className={cn("mx-auto max-w-3xl h-full md:flex flex-col justify-center")}>
        <div>
          <h2 className={cn("text-2xl")}>Name your course</h2>
          <p className={cn("text-sm text-foreground/50")}>What would you like to name your course? Don&apos;t worry you
            can
            change it later.</p>
        </div>
        <Form {...form}>
          <form onSubmit={onSubmit} className={cn("mt-8 flex flex-col gap-8")}>
            ...
            <div className={cn("space-x-4")}>
              ...
              <Button disabled={isSubmitting || !isValid} variant="default" type="submit">Continue</Button>
            </div>
          </form>
        </Form>
      </div>
